...
import sophon.desktop.feature.systemmonitor.feature.cpu.dumpsys.ui.CpuScreen
import sophon.desktop.feature.systemmonitor.feature.cpu.realtime.ui.RealtimeCpuScreen
    ...
    Column(
        ...
        Box(
            ...
            when (selectedFeature) {
                ...
                SystemMonitorFeature.REALTIME_CPU_MONITOR -> RealtimeCpuScreen(refreshTrigger)
...
enum class SystemMonitorFeature(val displayName: String) {
    TEMPERATURE("温度"),
    CPU_MONITOR("CPU(Dumpsys)"),
    REALTIME_CPU_MONITOR("CPU(实时)"),
    CAMERA_MONITOR("相机")
}
