    ...
    Canvas(modifier = modifier) {
        ...
        labels.forEach { (value, y) ->
            ...
            drawText(
                ...
                topLeft = Offset(
                    leftPadding - measuredText.size.width.toFloat() - 10f,
                    y - measuredText.size.height.toFloat() / 2
                )
            )
        ...
        timeLabels.forEach { (text, ratio) ->
            ...
            drawText(
                textLayoutResult = measuredText,
                topLeft = Offset(
                    leftPadding + chartWidth * ratio - measuredText.size.width.toFloat() / 2,
                    height - bottomPadding + 5f
                )
            )
        }
