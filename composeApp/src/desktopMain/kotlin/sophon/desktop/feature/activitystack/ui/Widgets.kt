...
import sophon.desktop.feature.activitystack.domain.model.ActivityInfo
import sophon.desktop.feature.activitystack.domain.model.FragmentInfo
    ...
    val (backgroundColor, textColor) = when (lifecycleComponent) {
        ...
        is FragmentInfo -> {
            when (lifecycleComponent.state) {
                FragmentInfo.State.RESUMED -> MaterialTheme.colorScheme.primary to MaterialTheme.colorScheme.onPrimary
                FragmentInfo.State.ATTACHED,
                FragmentInfo.State.CREATED,
                FragmentInfo.State.VIEW_CREATED,
                FragmentInfo.State.AWAITING_EXIT_EFFECTS,
                FragmentInfo.State.ACTIVITY_CREATED,
                    -> MaterialTheme.colorScheme.tertiary to MaterialTheme.colorScheme.onTertiary

                FragmentInfo.State.STARTED,
                FragmentInfo.State.AWAITING_ENTER_EFFECTS,
