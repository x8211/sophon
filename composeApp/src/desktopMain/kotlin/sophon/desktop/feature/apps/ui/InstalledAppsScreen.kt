 ...
 */
@Composable
fun InstalledAppsScreen(viewModel: InstalledAppsViewModel = viewModel { InstalledAppsViewModel() }) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        if (viewModel.isLoading && viewModel.apps.isEmpty()) { // Only show full loader if no apps loaded
            // 加载进度显示
            Column(
                modifier = Modifier
                    .fillMaxSize()
