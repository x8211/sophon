 ...
 * [addHttp2BackendCodec]，并将初始 Channel 通过 [BackendChannelManager.donateChannel] 移交；
...
internal class Http2MitmSession(
    ...
    fun install() {
        addHttp2FrontendPipeline(frontendChannel, backendManager, host, onPacketCaptured, idCounter)
    }
}
